...
string=PropTypes.string;var node=PropTypes.node;var bool=PropTypes.bool;var func=PropTypes.func;var oneOf=PropTypes.oneOf;
...
url,success,failure){
promiseForImage(url).then(function(_ref){var width=_ref.width;var height=_ref.height;return success(width,height);},failure);
}}]);
...
this.props;var accessibilityLabel=_props.accessibilityLabel;var accessible=_props.accessible;var children=_props.children;var defaultSource=_props.defaultSource;var source=_props.source;var testID=_props.testID;var onLayout=_props.onLayout;
...
extractStyles(this.props.style,this.props.resizeMode);var outer=_extractStyles.outer;var inner=_extractStyles.inner;var resizeMode=_extractStyles.resizeMode;
